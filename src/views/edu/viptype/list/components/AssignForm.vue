    ...
    >
        ...
        <el-form :model="modelRef" :rules="rulesRef" ref="formRef" label-width="80px">
              ...
              <el-transfer
                  ...
                  v-model="modelRef.courseTypeSets"
                  :props="{
                      key: 'id',
                      label: 'name'
                    }"
                  :data="modelRef.courseTypeList"
              ></el-transfer>
        </el-form>
...
export default defineComponent({
    ...
    setup(props): UpdateFormSetupData {
        ...
        const modelRef = reactive<TableListItem>({
            ...
            name: '正在给【'+props.values.name+'】分配权益' || '',
            vipMoney: props.values.vipMoney || 0,
            courseTypeSets: props.values.courseTypeSets || [],
            courseTypeList: props.values.courseTypeList || []
        });

        // console.info("modelRef.courseTypeList:",modelRef.courseTypeList)
