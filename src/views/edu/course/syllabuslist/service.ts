...
// 获取批量上传视频进度
export async function getBatchUploadPercentData(params: Omit<TableListItem, 'id'>): Promise<any> {
  return request({url: `/edu/vod/getBatchUploadPercent/${params.fileKey}`});
}
